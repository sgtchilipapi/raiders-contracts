...
///@notice This is a fork of SushiSwap's MiniChefV2 deployed on Polygon.
...
contract MiniChefV2 is BoringOwnable, BoringBatchable {
    ...
    function harvest(uint256 pid, address to) public {
        ...
        if (_pendingSushi != 0) {
            ...
            //Replaced safeTransfer() with mint() for simplicity purposes since this contract is being deployed only for the staking of CLANK
            //and the materials which have a mint() function exposed callable only by the owner (this contract).
