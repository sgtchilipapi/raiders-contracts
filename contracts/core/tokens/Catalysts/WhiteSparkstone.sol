...
contract WhiteSparkstone is ERC20, ERC20Burnable, Ownable {

    ///The LP token of $CLANK-$THUMP that will be burned to mint $wSPARK.
    LP_Token lp_token;
    constructor() ERC20("Catalyst White Sparkstone", " wSPARK") {
